...
#  UploadedToGithubBy: https://github.com/ghostinthewires                                                   # 
# 	                              										    # 
#  Date: 16/03/2016                                                         # 
...
{ 
  ...
  $msg.To.Add($user) 
        $msg.From = "user.name@domain.com" 
  $msg.Subject = "ghostinthewires Internal DiskSpace Report for $titledate" 
        $msg.IsBodyHTML = $true 
